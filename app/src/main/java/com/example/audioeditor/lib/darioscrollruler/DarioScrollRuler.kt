...
class DarioScrollRuler @JvmOverloads constructor(
    ...
    init {
        val attributes = context.obtainStyledAttributes(attrs, R.styleable.RangeView)
        minValue = attributes.getFloat(R.styleable.RangeView_minValue, minValue)
        maxValue = attributes.getFloat(R.styleable.RangeView_maxValue, maxValue)
        initialValue = attributes.getFloat(R.styleable.RangeView_initialValue, initialValue)
        attributes.recycle()

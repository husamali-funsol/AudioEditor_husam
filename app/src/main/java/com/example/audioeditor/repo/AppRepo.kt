...
//            val durationFormatted = duration.toInt().formatDuration()
    ...
    //recorded audio files list
    fun listRecordedAudioFiles(): ArrayList<LibraryItemModel> {
...
//                val durationFormatted = (duration.toInt().formatDuration())
    ...
    fun getSingleRecordedAudioFile(pos: Int): LibraryItemModel {
        ...
        val selection = "${MediaStore.Audio.Media.DATA} LIKE ?"
        val selectionArgs =
            arrayOf("%FunsolAudioRecorder%") // Filter for paths containing "FunsolAudioEditor"
